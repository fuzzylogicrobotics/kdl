...
namespace KDL {
    ...
    public:
        ...
        friend bool Equal(const RigidBodyInertia& a, const RigidBodyInertia& b, double eps);
    ...
    inline bool Equal(const RigidBodyInertia& a, const RigidBodyInertia& b, double eps=epsilon)
    {
        return Equal(a.m, b.m, eps)
            && Equal(a.h, b.h, eps)
            && Equal(a.I, b.I, eps);
    }
