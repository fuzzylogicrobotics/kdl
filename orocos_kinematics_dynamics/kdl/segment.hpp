...
namespace KDL {
    ...
    public:
        ...
        friend bool Equal(const Segment& a, const Segment& b, double eps);
    };

    inline bool Equal(const Segment& a, const Segment& b, double eps=epsilon)
    {
        return a.name == b.name
            && Equal(a.joint, b.joint,eps)
            && Equal(a.I, b.I,eps)
            && Equal(a.f_tip, b.f_tip,eps);
    }
